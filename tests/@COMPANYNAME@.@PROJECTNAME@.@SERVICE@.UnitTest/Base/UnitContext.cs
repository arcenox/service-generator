using _COMPANYNAME_._PROJECTNAME_._SERVICE_.Api.Extensions;
...
namespace _COMPANYNAME_._PROJECTNAME_._SERVICE_.UnitTest.Base
{
    public class UnitContext
    {
        ...
        {
            var context = builder.Services.FirstOrDefault(descriptor => descriptor.ServiceType == typeof(_SERVICE_DbContext));
            ...
            builder.Services.AddDbContext<_SERVICE_DbContext>(opts =>
            {
